  ...
  return (
    <section >
      ...
      <div className="bg-[#EFF4F8]" >
        <div className=" c-container mt-[173px] text-[#333333] pt-[300px] pb-[61px] md:pt-[645px] sm:pt-[990px] flex justify-center">
          ...
          <div className="flex justify-center items-start gap-[120px] xl:gap-[60px] lg:gap-[45px] md:flex-col md:items-center">
            <div className="flex-shrink-0 relative pl-7">
              ...
              <Image
                src={recWork}
                alt="rectangle work"
                className="relative z-10 xl:w-[400px] xl:h-[500px] lg:w-[310px] lg:h-[450px] md:w-[600px] md:h-[500px] sm:w-[400px] xs:w-[300px] xs:h-[400px]"
              />
              <div className="absolute -top-5 left-2  w-[265px] h-[274px] lg:h-[200px] lg:w-[198px] bg-[#EFF4F8]"></div>
            </div>
            <div>
